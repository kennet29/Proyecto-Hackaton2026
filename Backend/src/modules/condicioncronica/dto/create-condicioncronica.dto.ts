...
export class CreateCondicioncronicaDto extends createZodDto(createCondicioncronicaSchema) {}

export const updateCondicioncronicaSchema = z.object({
  pacienteId: z.number().int(),
  tipocondicionId: z.number().int(),
  fechadiagnostico: z.coerce.date().nullable().optional(),
  estado: z.string().optional(),
...
export class UpdateCondicioncronicaDto extends createZodDto(updateCondicioncronicaSchema) {}
