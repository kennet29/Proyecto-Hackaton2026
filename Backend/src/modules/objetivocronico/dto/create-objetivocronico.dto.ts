...
/**
 * Esquema Zod para validar la creación de objetivocronico.
 */
...
/**
 * DTO de entrada para crear objetivocronico.
 */
export class CreateObjetivocronicoDto extends createZodDto(
  createObjetivocronicoSchema,
) {}

/**
 * Esquema Zod para validar la actualización de objetivocronico.
 */
export const updateObjetivocronicoSchema = z
  .object({
    condicioncronicaId: z.number().int(),
    descripcion: z.string(),
    indicador: z.string().nullable().optional(),
...
/**
 * DTO de entrada para actualizar objetivocronico.
 */
export class UpdateObjetivocronicoDto extends createZodDto(
  updateObjetivocronicoSchema,
) {}
