...
export class CreateConsultamedicaDto extends createZodDto(createConsultamedicaSchema) {}

export const updateConsultamedicaSchema = z.object({
  pacienteId: z.number().int(),
  fechaconsulta: z.coerce.date(),
  motivo: z.string(),
  diagnostico: z.string().nullable().optional(),
...
export class UpdateConsultamedicaDto extends createZodDto(updateConsultamedicaSchema) {}
