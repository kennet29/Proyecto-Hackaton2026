...
/**
 * DTO de entrada para crear horariomedicamento.
 */
export class CreateHorariomedicamentoDto extends createZodDto(
  createHorariomedicamentoSchema,
) {}

/**
 * Esquema Zod para validar la actualización de horariomedicamento.
 */
export const updateHorariomedicamentoSchema = z
  .object({
    medicacionId: z.number().int(),
    horaprogramada: z.coerce.date(),
    frecuencia: z.string().nullable().optional(),
...
/**
 * DTO de entrada para actualizar horariomedicamento.
 */
export class UpdateHorariomedicamentoDto extends createZodDto(
  updateHorariomedicamentoSchema,
) {}
