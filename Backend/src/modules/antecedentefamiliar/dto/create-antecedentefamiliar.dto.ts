...
/**
 * Esquema Zod para validar la creación de antecedentefamiliar.
 */
...
/**
 * DTO de entrada para crear antecedentefamiliar.
 */
export class CreateAntecedentefamiliarDto extends createZodDto(
  createAntecedentefamiliarSchema,
) {}

/**
 * Esquema Zod para validar la actualización de antecedentefamiliar.
 */
export const updateAntecedentefamiliarSchema = z
  .object({
    pacienteId: z.number().int(),
    parentesco: z.string(),
    condicion: z.string(),
...
/**
 * DTO de entrada para actualizar antecedentefamiliar.
 */
export class UpdateAntecedentefamiliarDto extends createZodDto(
  updateAntecedentefamiliarSchema,
) {}
