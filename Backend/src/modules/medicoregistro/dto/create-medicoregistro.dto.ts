...
export const createMedicoregistroSchema = z.object({
  ...
  documentocedulaBase64: nullableString,
  documentocedulaNombre: z.string().max(260).nullable().optional(),
  documentocedulaMimeType: z.string().max(100).nullable().optional(),
