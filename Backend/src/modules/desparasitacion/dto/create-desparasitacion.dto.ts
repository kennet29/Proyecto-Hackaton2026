...
export class CreateDesparasitacionDto extends createZodDto(createDesparasitacionSchema) {}

export const updateDesparasitacionSchema = z.object({
  pacienteId: z.number().int(),
  fecha: z.coerce.date(),
  producto: z.string(),
  dosis: z.string().nullable().optional(),
...
export class UpdateDesparasitacionDto extends createZodDto(updateDesparasitacionSchema) {}
