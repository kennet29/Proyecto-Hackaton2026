...
/**
 * Esquema Zod para validar la creación de lesion.
 */
...
/**
 * DTO de entrada para crear lesion.
 */
export class CreateLesionDto extends createZodDto(createLesionSchema) {}

/**
 * Esquema Zod para validar la actualización de lesion.
 */
export const updateLesionSchema = z
  .object({
    pacienteId: z.number().int(),
    tipolesionId: z.number().int().nullable().optional(),
    fechalesion: z.coerce.date(),
...
/**
 * DTO de entrada para actualizar lesion.
 */
