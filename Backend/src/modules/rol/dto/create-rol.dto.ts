...
/**
 * Esquema Zod para validar la creación de rol.
 */
 ...
 */
export class CreateRolDto extends createZodDto(createRolSchema) {}

/**
 * Esquema Zod para validar la actualización de rol.
 */
...
/**
 * DTO de entrada para actualizar rol.
 */
export class UpdateRolDto extends createZodDto(updateRolSchema) {}
