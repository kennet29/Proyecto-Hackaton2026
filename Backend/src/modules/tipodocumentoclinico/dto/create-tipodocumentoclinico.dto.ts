...
export class CreateTipodocumentoclinicoDto extends createZodDto(createTipodocumentoclinicoSchema) {}

export const updateTipodocumentoclinicoSchema = z.object({
  nombre: z.string(),
  descripcion: z.string().nullable().optional(),
  creadopor: z.string().nullable().optional(),
  creadoen: z.coerce.date().optional(),
...
export class UpdateTipodocumentoclinicoDto extends createZodDto(updateTipodocumentoclinicoSchema) {}
