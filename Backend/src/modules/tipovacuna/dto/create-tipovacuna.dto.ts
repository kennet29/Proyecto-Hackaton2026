...
/**
 * Esquema Zod para validar la creación de tipovacuna.
 */
...
/**
 * DTO de entrada para crear tipovacuna.
 */
export class CreateTipovacunaDto extends createZodDto(createTipovacunaSchema) {}

/**
 * Esquema Zod para validar la actualización de tipovacuna.
 */
export const updateTipovacunaSchema = z
  .object({
    nombre: z.string(),
    dosisrequeridas: z.number().int().nullable().optional(),
    intervalodias: z.number().int().nullable().optional(),
...
/**
 * DTO de entrada para actualizar tipovacuna.
 */
