...
/**
 * Entidad TypeORM que modela el recurso tipovacuna.
 */
...
export class Tipovacuna {
   ...
   */
  @PrimaryGeneratedColumn({ name: "tipovacunaid", type: "int" })
  tipovacunaId!: number;
  ...
  /**
   * Campo de datos asociado a `dosisrequeridas`.
   */
  @Column({
    name: "dosisrequeridas",
    type: "int",
    precision: 10,
    nullable: true,
  })
  ...
  /**
   * Campo de datos asociado a `intervalodias`.
   */
  @Column({ name: "intervalodias", type: "int", precision: 10, nullable: true })
