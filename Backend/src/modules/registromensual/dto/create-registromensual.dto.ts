...
export class CreateRegistromensualDto extends createZodDto(createRegistromensualSchema) {}

export const updateRegistromensualSchema = z.object({
  pacienteId: z.number().int(),
  mes: z.number().int().nullable().optional(),
  anio: z.number().int(),
  fechainicio: z.coerce.date(),
...
export class UpdateRegistromensualDto extends createZodDto(updateRegistromensualSchema) {}
