...
/**
 * Esquema Zod para validar la creación de tipohabito.
 */
...
/**
 * DTO de entrada para crear tipohabito.
 */
export class CreateTipohabitoDto extends createZodDto(createTipohabitoSchema) {}

/**
 * Esquema Zod para validar la actualización de tipohabito.
 */
export const updateTipohabitoSchema = z
  .object({
    nombre: z.string(),
    categoria: z.string().nullable().optional(),
    descripcion: z.string().nullable().optional(),
...
/**
 * DTO de entrada para actualizar tipohabito.
 */
