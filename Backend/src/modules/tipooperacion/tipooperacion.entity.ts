...
/**
 * Entidad TypeORM que modela el recurso tipooperacion.
 */
@Entity({ name: "tipooperacion" })
export class Tipooperacion {
  /**
   * Identificador persistido para `tipooperacionId`.
   */
  @PrimaryGeneratedColumn({ name: "tipooperacionid", type: "int" })
  ...
  /**
   * Campo de datos asociado a `area`.
   */
  @Column({ name: "area", type: "nvarchar", length: 120, nullable: true })
  area?: string;
