...
/**
 * Esquema Zod para validar la creación de adherenciacronica.
 */
...
/**
 * DTO de entrada para crear adherenciacronica.
 */
export class CreateAdherenciacronicaDto extends createZodDto(
  createAdherenciacronicaSchema,
) {}

/**
 * Esquema Zod para validar la actualización de adherenciacronica.
 */
export const updateAdherenciacronicaSchema = z
  .object({
    condicioncronicaId: z.number().int(),
    medicacionId: z.number().int().nullable().optional(),
    fechaevento: z.coerce.date().optional(),
...
/**
 * DTO de entrada para actualizar adherenciacronica.
 */
export class UpdateAdherenciacronicaDto extends createZodDto(
  updateAdherenciacronicaSchema,
) {}
