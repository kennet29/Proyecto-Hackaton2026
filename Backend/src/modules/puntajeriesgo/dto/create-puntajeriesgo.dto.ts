...
export class CreatePuntajeriesgoDto extends createZodDto(createPuntajeriesgoSchema) {}

export const updatePuntajeriesgoSchema = z.object({
  pacienteId: z.number().int(),
  consultaId: z.number().int().nullable().optional(),
  tipo: z.string(),
  valordecimal: z.number().nullable().optional(),
...
export class UpdatePuntajeriesgoDto extends createZodDto(updatePuntajeriesgoSchema) {}
