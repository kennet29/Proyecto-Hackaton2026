...
export const createPermisoAccesoSchema = z
  ...
  .refine(
    (value) => (value.tipo === 'temporal' && value.duracion) || value.tipo === 'permanente',
    {
  ...
  .refine(
    (value) => !(value.tipo === 'permanente' && value.duracion),
    {
...
export class CreatePermisoAccesoDto extends createZodDto(createPermisoAccesoSchema) {}
