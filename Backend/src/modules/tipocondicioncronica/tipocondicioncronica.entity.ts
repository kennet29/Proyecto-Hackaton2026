...
/**
 * Entidad TypeORM que modela el recurso tipocondicioncronica.
 */
@Entity({ name: "tipocondicioncronica" })
export class Tipocondicioncronica {
  /**
   * Identificador persistido para `tipocondicionId`.
   */
  @PrimaryGeneratedColumn({ name: "tipocondicionid", type: "int" })
