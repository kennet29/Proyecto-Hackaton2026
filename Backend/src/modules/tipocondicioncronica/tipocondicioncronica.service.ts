...
/**
 * Implementa la lógica de negocio y persistencia del dominio tipocondicioncronica.
 */
@Injectable()
export class TipocondicioncronicaService {
  ...
  async findOne(id: string): Promise<Tipocondicioncronica> {
    ...
    if (!entity) {
      throw new NotFoundException(
        `registro ${id} no encontrado en tipocondicioncronica`,
      );
    }
    return entity;
  }
  ...
  async update(
    id: string,
    payload: UpdateTipocondicioncronicaDto,
  ): Promise<Tipocondicioncronica> {
