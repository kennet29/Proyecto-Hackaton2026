...
export class CreateTipocondicioncronicaDto extends createZodDto(createTipocondicioncronicaSchema) {}

export const updateTipocondicioncronicaSchema = z.object({
  nombre: z.string(),
  descripcion: z.string().nullable().optional(),
  categoria: z.string().nullable().optional(),
  activo: z.boolean().optional(),
...
export class UpdateTipocondicioncronicaDto extends createZodDto(updateTipocondicioncronicaSchema) {}
