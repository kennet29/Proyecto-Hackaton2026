...
import { NanoBibliotecaScreen } from './src/screens/NanoBibliotecaScreen';
import { PresupuestoMedicoScreen } from './src/screens/PresupuestoMedicoScreen';
...
import { AdminServerLogsScreen } from './src/screens/AdminServerLogsScreen';
...
const linking: LinkingOptions<RootStackParamList> = {
  ...
  config: {
    screens: {
      ...
      NanoBiblioteca: 'nano/biblioteca',
      PresupuestoMedico: 'presupuesto-medico',
...
const PrivateNavigator = () => {
  ...
  return (
    <View style={styles.privateRoot}>
      ...
      <Stack.Screen
        name="NanoBiblioteca"
        component={NanoBibliotecaScreen}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="PresupuestoMedico"
        component={PresupuestoMedicoScreen}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="NanoHistorial"
      ...
      <Stack.Screen name="AdminServerLogs" component={AdminServerLogsScreen} options={{ title: 'Registros del servidor' }} />
      <Stack.Screen
        name="DocumentoForm"
