    ...
    <SafeAreaView style={styles.safeArea} edges={['bottom']}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
            ...
            return (
              ...
              >
                <View style={[styles.sample, selected && styles.sampleSelected]}>
                  <AppText style={[styles.sampleText, { fontSize: option.sampleSize }]}>{option.value === 'small' ? 'Aa' : 'Aa'}</AppText>
                </View>
                ...
                <Ionicons name={selected ? 'radio-button-on' : 'radio-button-off'} size={24} color={selected ? appColors.info : appColors.textMuted} />
              </TouchableOpacity>
            );
          })}
        </View>
        ...
        <View style={styles.preview}>
          <Ionicons name="eye-outline" size={20} color={appColors.success} />
...
const styles = StyleSheet.create({
  ...
  section: { padding: 18, borderRadius: 20, backgroundColor: appColors.surface, borderWidth: 1, borderColor: appColors.border, gap: 12 },
  sectionTitle: { color: appColors.text, fontSize: 18, fontWeight: '900' },
  sectionDescription: { color: appColors.textSoft, fontSize: 13, lineHeight: 19, marginBottom: 4 },
  option: { minHeight: 78, padding: 12, borderRadius: 15, borderWidth: 1, borderColor: appColors.border, flexDirection: 'row', alignItems: 'center', gap: 12 },
  optionSelected: { borderColor: appColors.info, backgroundColor: '#0B6FEA18' },
  sample: { width: 50, height: 50, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: appColors.background },
  sampleSelected: { backgroundColor: '#0B6FEA' },
  sampleText: { color: '#FFFFFF', fontWeight: '900' },
  optionCopy: { flex: 1 },
  optionTitle: { color: appColors.text, fontSize: 15, fontWeight: '800' },
  optionDescription: { color: appColors.textSoft, fontSize: 12, lineHeight: 17, marginTop: 2 },
  preview: { flexDirection: 'row', gap: 11, padding: 16, borderRadius: 18, borderWidth: 1, borderColor: '#2E8B573F', backgroundColor: '#38E28E16' },
  previewCopy: { flex: 1 },
  previewTitle: { color: appColors.success, fontSize: 14, fontWeight: '900' },
  previewText: { color: appColors.text, fontSize: 13, lineHeight: 19, marginTop: 2 },
  backButton: { alignSelf: 'center', minHeight: 46, paddingHorizontal: 18, borderRadius: 14, backgroundColor: appColors.info, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
