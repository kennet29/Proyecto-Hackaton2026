...
const styles = StyleSheet.create({
  ...
  safetyHelp:{color:appColors.textMuted,fontSize:12,lineHeight:17},safetyOptions:{gap:8},safetyOption:{minHeight:42,paddingHorizontal:12,borderRadius:12,borderWidth:1,borderColor:appColors.border,backgroundColor:appColors.surface,flexDirection:'row',alignItems:'center',gap:9},safetyOptionSelected:{borderColor:appColors.accent,backgroundColor:colorAlpha(appColors.accent,'14')},safetyOptionText:{color:appColors.text,fontSize:13,fontWeight:'800'},medicalWarning:{flexDirection:'row',gap:9,padding:12,borderRadius:12,borderWidth:1,borderColor:colorAlpha(appColors.accent,'70'),backgroundColor:colorAlpha(appColors.accent,'14')},medicalWarningText:{flex:1,color:appColors.textSoft,fontSize:12,lineHeight:17,fontWeight:'700'},lowImpactNotice:{flexDirection:'row',gap:9,padding:12,borderRadius:12,borderWidth:1,borderColor:colorAlpha(appColors.success,'70'),backgroundColor:colorAlpha(appColors.success,'12')},lowImpactText:{flex:1,color:appColors.textSoft,fontSize:12,lineHeight:17,fontWeight:'700'},
});
