...
const styles = StyleSheet.create({
  ...
  container: { padding: 24, paddingBottom: 110, backgroundColor: '#fff' },
  title: { fontSize: 24, fontWeight: '800', color: '#0f172a' },
  subtitle: { marginTop: 6, marginBottom: 18, color: '#64748b' },
  filterCard: { backgroundColor: '#f8fafc', borderRadius: 14, padding: 16, borderWidth: 1, borderColor: '#e2e8f0', marginBottom: 18 },
  formCard: { backgroundColor: '#f8fafc', borderRadius: 14, padding: 16, borderWidth: 1, borderColor: '#e2e8f0', marginTop: 8 },
  ...
  pickerWrapper: { borderWidth: 1, borderColor: '#d4d4d8', borderRadius: 12, overflow: 'hidden', marginBottom: 8, backgroundColor: '#fff' },
  patientHint: { color: '#475569' },
  dateButton: { borderWidth: 1, borderColor: '#d4d4d8', borderRadius: 12, paddingVertical: 14, paddingHorizontal: 12, marginBottom: 12, backgroundColor: '#fff' },
  dateButtonText: { color: '#111827', textAlign: 'center', fontSize: 15 },
  iosPickerCard: { borderWidth: 1, borderColor: '#d4d4d8', borderRadius: 12, overflow: 'hidden', backgroundColor: '#fff', marginBottom: 12 },
  secondaryBtn: { alignSelf: 'flex-end', paddingHorizontal: 16, paddingVertical: 12 },
  secondaryBtnText: { color: '#0ea5e9', fontWeight: '700' },
  input: { borderWidth: 1, borderColor: '#d4d4d8', borderRadius: 12, padding: 14, marginBottom: 12, fontSize: 15, backgroundColor: '#fff' },
  multiline: { minHeight: 96, textAlignVertical: 'top' },
  switchRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderWidth: 1, borderColor: '#d4d4d8', borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, marginBottom: 12, backgroundColor: '#fff' },
  switchLabel: { color: '#111827', fontWeight: '700' },
  formActions: { flexDirection: 'row', gap: 12 },
  cancelBtn: { flex: 1, borderRadius: 12, paddingVertical: 15, alignItems: 'center', borderWidth: 1, borderColor: '#cbd5e1', backgroundColor: '#fff' },
  ...
  card: { backgroundColor: '#f8fafc', borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#e2e8f0' },
  cardTitle: { color: '#0f172a', fontWeight: '800', fontSize: 16, marginBottom: 8 },
