...
export function LocationMapPicker({ latitude, longitude, onLocationChange }: Props) {
  ...
  return <View style={styles.wrapper}>
    <View style={styles.heading}><Ionicons name="location-outline" size={18} color={colors.info} /><AppText style={styles.title}>Escoge la ubicación en el mapa</AppText></View>
...
const createStyles = (colors: AppColors) => StyleSheet.create({
  wrapper: { borderRadius: 14, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface, padding: 12 },
  ...
  text: { color: colors.textMuted, fontSize: 12, lineHeight: 17, marginTop: 8 },
});
