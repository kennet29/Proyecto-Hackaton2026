...
| `consultamedica`, `citamedica`, `documentoclinico`, `notificacion`, `recordatoriocita`, `medicacion`, `horariomedicamento`, `lesion`, `vacuna`, `operacion` | Registros clinicos principales.
